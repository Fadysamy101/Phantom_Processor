#!/usr/bin/env python3
"""
Enhanced Assembler for Team1 Instruction Set Architecture
...
- Data statements
- Labels and more robust error handling
- Full 32-bit binary output display
    ...
    def write_output(self, output_file):
        ...
        with open(readable_output, 'w') as f:
            ...
            for address, binary in binary_output:
                ...
                # Modified to show all 32 bits of binary instead of truncating
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python ModifiedAssembler.py input_file.asm [output_file]")
        print("  input_file.asm: Assembly source file to assemble")
        print("  output_file: Optional output file (default: input_file_base.bin)")
        return
    ...
    # Default output file name is the input filename with .bin extension
    if len(sys.argv) > 2:
    ...
    try:
        ...
        assembler.write_output(output_file)
